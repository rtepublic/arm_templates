...
resource dataStoreStorageAccount 'Microsoft.Storage/storageAccounts@2023-05-01' = {
  name: toLower('${name}dsa')
  location: location
  sku: {
    name: 'Premium_LRS'
  }
...
resource dataStoreStorageAccountBlob 'Microsoft.Storage/storageAccounts/blobServices@2023-05-01' = {
  parent: dataStoreStorageAccount
  name: 'default'
}

resource dataStoreStorageAccountContainer 'Microsoft.Storage/storageAccounts/blobServices/containers@2023-05-01' = {
  parent: dataStoreStorageAccountBlob
  name: containerName
}
